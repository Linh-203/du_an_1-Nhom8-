  ...
  <div class="container">
    ...
    <div class="menu" style="background-color: #232f3e;padding: 10px;margin-left: 0px;display: flex;justify-content: space-between;">
        ...
        <main style="display: flex;background-color: rgba(245, 245, 245, 1);" >
            ...
            <a href="./change_pass.php" style=" background-color: #ee4d2d; width: 83%;color:white"><i style="font-size: 20px;margin-right: 5px;" class="fab fa-expeditedssl" style="margin-right: 3px;"></i> Đổi mật khẩu</a> <br>
